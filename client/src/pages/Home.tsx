    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300 relative overflow-hidden">
            ...
            <section className="relative z-10 bg-gradient-to-br from-blue-50/40 via-white to-transparent
                                dark:from-slate-900/40 dark:via-slate-950 dark:to-transparent">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
                        ...
                        <div className="flex-1 min-w-0 flex flex-col gap-6">
                            ...
                            <div className="inline-flex items-center gap-2 self-start px-3.5 py-1.5
                                            rounded-full bg-blue-50/50 dark:bg-blue-950/20
                                            border border-blue-100/50 dark:border-blue-900/30
                                            text-[10px] font-black tracking-wider uppercase
                                            text-blue-700 dark:text-blue-300 shadow-sm animate-float">
                                <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse" />
                                <span>🎓 India's Most Practical Virtual Internship Platform</span>
                            </div>

                            {/* Main Headings */}
                            <div className="font-extrabold text-slate-900 dark:text-white leading-[1.08] tracking-tight"
                            ...
                            {/* Hero Subtitle */}
                            <p className="text-slate-500 dark:text-slate-400 text-sm sm:text-base leading-relaxed max-w-lg font-medium">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 max-w-lg">
                                ...
                                <FeatureItem
                                    ...
                                    textClass="text-purple-750 dark:text-purple-300"
                                />
                                <FeatureItem
                                    icon={Award}
                                    ...
                                    textClass="text-emerald-750 dark:text-emerald-300"
                                />
                                <FeatureItem
                                    icon={Globe}
                                    label="100% Remote"
                            ...
                            <div className="flex flex-wrap gap-4 pt-2">
                                <button
                                    ...
                                    className="flex items-center gap-2 px-8 py-4 bg-blue-600
                                               hover:bg-blue-700 text-white font-bold rounded-2xl
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-7 py-4 bg-slate-50
                                               ...
                                               dark:hover:bg-slate-805 active:scale-[0.97]"
                                >
            ...
            <section className="border-y border-slate-150/80 dark:border-slate-800/80
                ...
                <div className="max-w-7xl mx-auto px-6 text-center space-y-3">
                    <p className="text-[9px] font-black uppercase tracking-[0.25em] text-slate-400 dark:text-slate-500">
                        What You'll Gain
                    </p>
            ...
            <section id="how-it-works" className="py-20 max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
                <div className="text-center space-y-3 mb-14">
                    <div className="inline-flex items-center space-x-1.5 px-3 py-1 bg-blue-50/60 dark:bg-blue-950/20 border border-blue-100/50 dark:border-blue-900/30 rounded-full text-[10px] font-extrabold text-blue-650 dark:text-blue-300 uppercase tracking-widest">
                        <Sparkles size={11} className="text-blue-500" />
                        <span>Simple Process</span>
                    </div>
                    <h2 className="text-4xl font-extrabold text-slate-805 dark:text-white tracking-tight">How It Works</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        { no: '01', title: 'Apply & Register', desc: 'Pick a domain, fill in your details, and grab an instant offer letter — no interview processes.', color: 'text-blue-600   bg-blue-50/50   dark:bg-blue-950/20 border-blue-100' },
                        { no: '02', title: 'Get Your ID Card', desc: 'Receive your virtual intern identity card and step into Vinix\'s verified community network.', color: 'text-purple-600 bg-purple-50/50 dark:bg-purple-950/20 border-purple-100' },
                        ...
                        { no: '04', title: 'Earn Certificate', desc: 'Get your secure QR-verified certificate. Export it to LinkedIn, your CV, and trigger tech referrals.', color: 'text-emerald-600 bg-emerald-50/50 dark:bg-emerald-950/20 border-emerald-100' },
                    ].map((s, idx) => (
            ...
            {/* ═══════ REVIEWS SECTION (RESOLVES BROKEN FEATURE) ═══════ */}
            <section id="reviews" className="py-20 border-t border-slate-100 dark:border-slate-900 bg-slate-50/30 dark:bg-slate-900/10 relative z-10">
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    ...
                    <div className="text-center space-y-3 mb-14">
                        <div className="inline-flex items-center space-x-1.5 px-3 py-1 bg-purple-50/60 dark:bg-purple-950/20 border border-purple-100/50 dark:border-purple-900/30 rounded-full text-[10px] font-extrabold text-purple-650 dark:text-purple-300 uppercase tracking-widest">
                        ...
                        {testimonials.map((t) => (
                            <div key={t.id} className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-150/80 dark:border-slate-800/80 shadow-sm space-y-4 hover:shadow-md transition duration-300">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-[9px] font-extrabold px-2.5 py-1 bg-blue-50 text-blue-750 dark:bg-blue-950/40 dark:text-blue-300 rounded-full">
                                        {t.domain}
                                    </span>
                                </div>
                                ...
                                <div className="pt-2 border-t border-slate-100 dark:border-slate-800 flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-[10px] text-slate-400 font-semibold">{t.college}</span>
                                    </div>
                                </div>
                            </div>
                        ))}
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/60 dark:border-slate-800/80 shadow-xl p-8 max-w-2xl mx-auto relative overflow-hidden">
                        ...
                        <form onSubmit={handleAddReview} className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    <label className="text-[10px] font-black uppercase text-slate-400 tracking-wider">Internship Track</label>
                                    <select
                                        value={newDomain}
                            ...
                            <div className="space-y-1">
                                ...
                                <textarea
                                    ...
                                    className="w-full text-xs font-semibold bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-3.5 py-3 focus:outline-none focus:border-blue-500 text-slate-800 dark:text-white resize-none"
                                />
                            </div>

                            <button
                                type="submit"
                                className="w-full py-4.5 bg-indigo-900 hover:bg-indigo-805 text-white font-extrabold text-xs  rounded-xl transition shadow active:scale-[0.98] flex items-center justify-center gap-1.5"
                            >
                                <Send size={13} />
            ...
            <section id="contact" className="py-20 border-t border-slate-100 dark:border-slate-900 relative z-10">
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    ...
                    <div className="text-center space-y-3 mb-14">
                        <div className="inline-flex items-center space-x-1.5 px-3 py-1 bg-amber-50/60 dark:bg-amber-950/20 border border-amber-100/50 dark:border-amber-900/30 rounded-full text-[10px] font-extrabold text-amber-650 dark:text-amber-300 uppercase tracking-widest">
                            <Users size={11} className="text-amber-550" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start max-w-5xl mx-auto">
                        ...
                        {/* Right Contact form */}
                        <div className="lg:col-span-7 bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-803 rounded-3xl p-8 shadow-xl">
                            {contactSent ? (
                                <div className="text-center py-10 space-y-4">
                                    <div className="w-16 h-16 bg-green-105 border border-green-200 text-green-600 rounded-full flex items-center justify-center mx-auto text-2xl animate-float">
                                        ✓
                                    </div>
                                ...
                                <form onSubmit={handleSendMessage} className="space-y-4">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div className="space-y-1">
                                            ...
                                            <input
                                                ...
                                                className="w-full text-xs font-medium bg-slate-50 dark:bg-slate-950 border border-slate-202 dark:border-slate-800 rounded-xl px-3.5 py-3 focus:outline-none focus:border-blue-500 text-slate-800 dark:text-white"
                                            />
                                        </div>
                                        <div className="space-y-1">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full text-xs font-semibold bg-slate-50 dark:bg-slate-955 border border-slate-202 dark:border-slate-800 rounded-xl px-3.5 py-3 focus:outline-none focus:border-blue-500 text-slate-800 dark:text-white resize-none"
                                        />
                                    </div>
