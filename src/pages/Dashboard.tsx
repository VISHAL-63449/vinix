                    ...
                    >
                        ...
                        <div className="relative flex justify-between items-center z-20 px-10 pt-6 w-full">
                            ...
                            <div className="flex items-center">
                                <div className="w-[52px] h-[52px] bg-[#0b2545] rounded-md flex items-center justify-center p-1 flex-shrink-0 shadow-xs border border-slate-205/20">
                            ...
                            <div className="flex items-center">
                                <div className="bg-white p-1.5 border border-slate-200/50 rounded flex items-center justify-center shadow-xs h-10 w-24">
                        ...
                        <div className="relative text-center z-20 mt-10 flex flex-col items-center">
                            <h2 className="text-[42px] font-extrabold text-[#0b1a30] tracking-[0.22em] leading-none uppercase font-sans">
                                CERTIFICATE
                            </h2>
                            <h4 className="text-[11px] font-medium text-[#0b1a30] tracking-[0.35em] leading-none mt-2.5 uppercase font-sans">
                                OF INTERNSHIP COMPLETION
                            </h4>
                        </div>

                        {/* Recipient presentation line */}
                        <div className="relative text-center z-20 flex flex-col items-center mt-12">
                            <p className="text-[10px] text-slate-405 tracking-wide font-sans">This certificate is proudly presented to</p>
                            <h3 className="text-[28px] font-bold text-[#0b1a30] tracking-wide mt-3 font-sans leading-none">
                                {profile?.full_name || 'Vinix Graduate'}
                            </h3>
                            <div className="w-[220px] h-[1px] bg-slate-200 mt-2"></div>
                        </div>

                        {/* Body description */}
                        <div className="relative text-center z-20 px-12 mt-12">
                            <p className="text-[10px] text-slate-500 max-w-[645px] mx-auto leading-relaxed font-sans font-medium">
                                for successfully completing the task-based virtual internship program in{' '}
                                <strong className="text-[#0b1a30] font-bold select-all">{activeCertForDownload.course_name}</strong> at{' '}
                        ...
                        <div className="relative flex justify-between items-end z-20 px-24 mt-11 w-full">
                            ...
                            <div className="flex flex-col items-center text-center pb-1">
                                ...
                                <p className="text-[6.5px] font-normal text-slate-400 tracking-[0.1em] uppercase leading-none whitespace-nowrap mt-1 font-sans">Official Seal</p>
                            </div>

                            {/* Right Signature */}
                            <div className="text-center flex flex-col items-center min-w-[140px] pb-1">
                                <span className="font-['Great_Vibes'] text-2xl text-slate-800 select-none transform -rotate-1 font-medium inline-block mb-1 whitespace-nowrap">
                                    Vishal R.
                                </span>
                                <div className="w-28 h-[1px] bg-slate-200"></div>
                                <h5 className="text-[9px] font-bold text-[#0b1a30] mt-1.5 leading-none whitespace-nowrap font-sans">Vishal R</h5>
                                <p className="text-[8px] font-medium text-slate-400 mt-0.5 leading-none whitespace-nowrap font-sans">Founder & CEO</p>
                            </div>
                        </div>
                        ...
                        <div className="relative w-full z-20 mt-8">
                            ...
                            <div className="flex justify-between items-center px-10 pb-1 text-[7.5px] text-slate-450 font-sans tracking-wide">
                                ...
                                <div className="text-center flex flex-col items-center">
                                    ...
                                    <div className="mt-0.5 text-[6.5px]">Verify at: visha19932-maker.github.io/verify/{activeCertForDownload.certificate_number}</div>
                                </div>
                                <div className="text-right">Issued: {new Date(activeCertForDownload.issue_date).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}</div>
                            </div>
                        </div>
                    </div>
                </div>
