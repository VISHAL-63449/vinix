                            ...
                            >
                                ...
                                <div className="space-y-1">
                                    ...
                                    <a
                                        ...
                                        className="text-base font-extrabold text-slate-900 dark:text-white mt-1 group-hover:text-blue-650 dark:group-hover:text-[#4fc3f7] transition duration-200 block"
                                    >
                                        foundervinix@gmail.com
                                    </a>
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-xs text-slate-500 dark:text-slate-400 max-w-sm mx-auto leading-relaxed font-semibold">
                                            Thank you for reaching out. We will review your message and contact you at <span className="text-slate-800 dark:text-slate-200 font-bold">foundervinix@gmail.com</span> or via your registered email.
                                        </p>
                                    </div>
                                </div>
                            ) : (
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <input
                                                type="email"
                                                required
                                                placeholder="e.g. foundervinix@gmail.com"
                                                value={contactEmail}
