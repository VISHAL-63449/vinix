                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="relative flex justify-between items-center z-20 px-10 pt-4 pb-2 border-t border-slate-100 mt-6 text-[8px] text-slate-400 font-mono w-full">
                                        ...
                                        <div className="text-right">Issued: {new Date(result.issueDate).toLocaleDateString('en-US', { month: 'numeric', day: 'numeric', year: 'numeric' })}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
