                                ...
                                >
                                    ...
                                    <div className="relative flex justify-between items-center z-20 px-10 pt-6 w-full font-sans">
                                        ...
                                        <div className="text-center flex flex-col items-center">
                                            ...
                                            <span className="text-[13px] font-normal text-slate-400 tracking-[0.1em] block mt-2">
                                    ...
                                    <div className="relative text-center z-20 flex flex-col items-center mt-10 font-sans">
                                        <p className="text-[15px] text-slate-400 tracking-wide">This certificate is proudly presented to</p>
                                        <h3 className="text-[48px] font-bold text-[#0b1a30] tracking-wide mt-3.5 leading-none capitalize">
                                            {result.studentName}
                                        </h3>
                                        <div className="w-[280px] h-[1.5px] bg-slate-205 mt-2.5"></div>
                                    </div>
                                    ...
                                    <div className="relative flex justify-between items-end z-20 px-24 mt-10 w-full font-sans">
                                        ...
                                        <div className="flex flex-col items-center text-center pb-1">
                                            ...
                                            <p className="text-[10.5px] font-semibold text-slate-400 tracking-[0.1em] uppercase leading-none whitespace-nowrap mt-1">Official Seal</p>
                                        </div>
                                        ...
                                        <div className="text-center flex flex-col items-center min-w-[180px] pb-1">
                                            ...
                                            <h5 className="text-[14px] font-bold text-[#0b1a30] mt-2.5 leading-none whitespace-nowrap">Vishal R</h5>
                                            <p className="text-[11px] font-medium text-slate-400 mt-1 leading-none whitespace-nowrap">Founder & CEO</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="relative w-full z-20 mt-8 font-sans">
                                        ...
                                        <div className="flex justify-between items-center px-10 pb-1 text-[11px] text-slate-450 tracking-wide">
                                            ...
                                            <div className="text-center flex flex-col items-center">
                                                ...
                                                <div className="mt-0.5 text-[10px]">Verify at: visha19932-maker.github.io/verify/{result.certificateNumber}</div>
                                            </div>
