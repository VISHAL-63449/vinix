                                ...
                                >
                                    ...
                                    <div className="relative flex justify-between items-center z-20 px-10 pt-6 w-full">
                                        ...
                                        <div className="text-center flex flex-col items-center">
                                            ...
                                            <span className="text-[8px] font-normal text-slate-400 tracking-[0.1em] block mt-1.5 uppercase font-sans">
                                    ...
                                    <div className="relative text-center z-20 mt-10 flex flex-col items-center">
                                        ...
                                        <h4 className="text-[11px] font-medium text-slate-400 tracking-[0.35em] leading-none mt-2.5 uppercase font-sans">
                                    ...
                                    <div className="relative text-center z-20 flex flex-col items-center mt-12">
                                        <p className="text-[10px] text-slate-400 tracking-wide font-sans">This certificate is proudly presented to</p>
                                    ...
                                    <div className="relative w-full z-20 mt-8">
                                        ...
                                        <div className="flex justify-between items-center px-10 pb-1 text-[7.5px] text-slate-450 font-sans tracking-wide">
                                            ...
                                            <div className="text-center flex flex-col items-center">
                                                ...
                                                <div className="mt-0.5 text-[6.5px]">Verify at: visha19932-maker.github.io/verify/{result.certificateNumber}</div>
                                            </div>
