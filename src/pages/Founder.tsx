...
export const Founder: React.FC = () => {
    ...
    return (
        <div className="overflow-x-hidden min-h-screen bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100 transition-colors duration-300">
            ...
            <h1 className="sr-only">Vishal R - Founder of Vinix</h1>
                    ...
                    <div className="mx-auto max-w-xl p-8 bg-white dark:bg-slate-900 rounded-[32px] border border-slate-200 dark:border-slate-800 shadow-xl flex flex-col md:flex-row items-center gap-8 text-left hover:shadow-2xl transition duration-300">
                        ...
                        <div className="space-y-3">
                            <div className="space-y-0.5">
                                ...
                                <span className="text-xs font-extrabold text-blue-600 dark:text-blue-400 uppercase tracking-widest block font-mono">Founder of Vinix</span>
                            </div>
