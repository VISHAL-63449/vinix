                        ...
                        {user ? (
                            <div className="flex items-center space-x-3">
                                ...
                                <div className="flex items-center space-x-2 select-none pl-1">
                                    <div className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-350 font-extrabold text-sm border border-slate-200/50 dark:border-slate-700/50 flex items-center justify-center">
                                        {profile?.full_name?.charAt(0).toUpperCase() || user.email?.charAt(0).toUpperCase() || 'U'}
                                    </div>
                                    <span className="text-xs font-semibold text-slate-550 dark:text-slate-400 max-w-[100px] truncate">
